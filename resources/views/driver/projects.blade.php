                ...
                <div id="resource-{{ $index }}" class="collapse">
                    <div class="card-body">
                        ...
                        <div class="card-body p-0">
                            ...
                            @if($resource->status == 'to be delivered')
                                <!-- Button trigger modal -->
                                <a href="{{route('driver.delivery.update', ['resource_id' => $resource->id, 'action' => 'start'])}}" class="btn btn-primary w-100 w-sm-auto">
                                    Start Delivery
                                </a>
                            @else
                                <!-- Button trigger modal -->
                                <a href="{{route('driver.delivery', $resource->id)}}" class="btn btn-primary w-100 w-sm-auto">
                                    View Delivery
                                </a>
                            @endif
                        </div>
