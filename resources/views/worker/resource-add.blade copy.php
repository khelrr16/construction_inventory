                ...
                <div class="tab-pane fade show @if(session('active_tab') == $resource->id) active @endif" id="resource" role="tabpanel">
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover mb-0">
                                        ...
                                        <tbody>
                                            @forelse($availableItems as $index3 => $item)
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="7" class="text-center text-muted">Resources unavailable
                                                    </td>
                                                </tr>
                                            @endforelse
                                        </tbody>
                    ...
                    {{-- <div class="modal fade" id="resourceModal" tabindex="-1" aria-labelledby="resourceModalLabel">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <form
                                    action="{{ route('worker.resource_item.add', ['project_id' => $project->id, 'resource_id' => $resource->id]) }}"
                                    method="POST">
                                    @csrf
                                    ...
                                    <div class="modal-body">
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-hover mb-0">
                                                ...
                                                <tbody>
                                                    @forelse($resource->availableItems as $index3 => $item)
                                                        <tr onclick="toggleSelect(this)">
                                                            <td class="d-none">
                                                                <input type="checkbox" name="resource_items[]"
                                                                    value="{{ $item->id }}">
