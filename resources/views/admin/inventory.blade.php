      ...
      <form action="{{route('items.store')}}" method="POST">
        ...
        <div class="row">
          <div class="col-md-4 mb-3">
            ...
            <input name="cost" type="number" class="form-control" placeholder="₱0.00">
          </div>
          <div class="col-md-4 mb-3">
            <label class="form-label">Measure</label>
            <input name="measure" type="text" class="form-control" placeholder="e.g. kg, pcs">
          </div>
          <div class="col-md-4 mb-3">
            <label class="form-label">Stocks</label>
            <input name="stocks" type="number" class="form-control" placeholder="0">
          </div>
        </div>
